...
# Creating books with the values from the migration files. These are default values that will be put into the database when seeded.
...
b11 = Book.create(title: "Complete Guide to Angular", author: "Google", description: "The bible to Angular", publisher: "Random House", weeks_on_list: 32, rank_this_week: 1)

b12 = Book.create(title: "NodeJs", author: "Greg Lim", description: "The bible to Nodejs and Express", publisher: "Random House", weeks_on_list: 20, rank_this_week: 2)

# Default review data that will be put into the database
...
Review.create(comment: "This book saved my career. It taught me everything there is to know about the Angular Framework", author: "ANON", book_id: b11.id)

Review.create(comment: "This book is very well thoughout and thourough. It has very good examples and techniques.", author: "Lim-crazy", book_id: b12.id)